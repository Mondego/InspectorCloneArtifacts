var ExperimentAction = function () {
    ...
    this.registerListeners = function () {
        $("#next").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: SITE_DEFAULTS.baseurl + '/pf/exp/' + experiment_id + '/evaluate',
                ...
                success: function (data) {
                    ...
                    if (data.message === "finished") {
                        ...
                        that.resetInputs();
                        Prism.highlightAll();
                        $("#current_status").text("( " + data.left + " more to evaluate)");
    ...
    this.initExp = function () {
        $.ajax({
            type: "POST",
            url: SITE_DEFAULTS.baseurl + '/pf/exp/' + experiment_id + '/initExp',
            data: {
